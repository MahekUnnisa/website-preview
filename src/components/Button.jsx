...
const Button = ({
  ...
  const baseStyles = 'font-medium rounded-[0.625rem] transition-all duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-offset-background disabled:cursor-not-allowed disabled:opacity-60';
